      ...
      <main class="flex-1 min-w-0 bg-slate-50 overflow-y-auto p-4 sm:p-6 lg:p-10">
        <div class="max-w-6xl mx-auto">
          ...
          <div v-else>
            ...
            <!-- Loading State -->
            <div v-if="isLoading" class="bg-white rounded-xl border border-slate-200 p-12 text-center">
              <Loader2 class="h-8 w-8 text-indigo-600 animate-spin mx-auto mb-4" />
              <p class="text-slate-600">Загрузка участников...</p>
            </div>
            ...
            <!-- Members Table -->
            <div v-else-if="members.length > 0" class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                          <span class="font-medium text-slate-900 truncate">{{ invitation.email }}</span>
                          <span
                            :class="[
                    ...
                    <div v-if="!isExpired(invitation.expires_at)" class="mt-2">
                      <div class="flex items-center gap-2">
                        <input
                          ...
                          readonly
                          class="flex-1 px-3 py-1.5 text-xs text-slate-600 bg-slate-50 border border-slate-200 rounded-lg truncate"
                        />
                      </div>
                    </div>
                  </div>
