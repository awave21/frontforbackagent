<template>
  <Dialog :open="isOpen" @update:open="(v) => !v && handleClose()">
    <DialogContent
      :class-name="step === 'columns' ? 'max-w-3xl' : 'max-w-xl'"
        ...
        <DialogHeader class="mb-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <DialogDescription>Выберите тип справочника</DialogDescription>
            </div>
            <DialogClose />
          </div>
        </DialogHeader>
        ...
        <DialogHeader class="mb-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div>
                <DialogTitle>Настройка справочника</DialogTitle>
                <DialogDescription>{{ selectedTemplateData?.label }}</DialogDescription>
              </div>
            </div>
            <DialogClose />
          </div>
        ...
        <div class="flex items-center justify-between p-6 border-b border-slate-100">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription>{{ form.name || 'Произвольный справочник' }}</DialogDescription>
            </div>
          </div>
          <DialogClose />
        </div>
