<template>
  <div
    class="bg-background rounded-md border border-border p-4 hover:border-slate-300 transition-all cursor-pointer group"
    @click="$emit('click')"
  >
    <div class="flex items-center justify-between gap-4">
      <div class="flex items-center gap-4 min-w-0">
        <div class="w-11 h-11 bg-indigo-50 rounded-md flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-100 transition-colors">
