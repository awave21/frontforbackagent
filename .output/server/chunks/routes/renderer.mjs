...
import { j as joinURL, u as useRuntimeConfig, d as defineRenderHandler, g as getQuery, c as createError, a as getRouteRules, b as getResponseStatusText, e as getResponseStatus, f as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Agents App - AI Integration Platform"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"ru"}};
